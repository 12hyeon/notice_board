            ...
            <div class="table_bgbox">
               ...
               <div id="board_read">
				   ...
				   <span id="user_info">
					   ...
					   <div id="bo_line"></div>
					   <div id="bo_content"><?php echo nl2br("$board[content]"); ?></div>
					</span>
                  <!-- 목록, 수정, 삭제 -->
				  <span id="bo_ser">
                       <ul style="padding: 0;">
                            ...
                            <form method="post" action="modify.php">
                               <input type="hidden" name="rno" value="<?php echo $board['idx']; ?>"><input type="hidden" name="b_no" value="<?php echo $bno; ?>">비밀번호<input type="password" size="10" name="pw"> <input type="submit" value="수정">
                           </form>
                        </li>
			                <li>
                           <form method="post" action="delete.php">
                           <input type="hidden" name="rno" value="<?php echo $board['idx']; ?>"><input type="hidden" name="b_no" value="<?php echo $bno; ?>">비밀번호<input type="password" size="10" name="pw"> <input type="submit" value="삭제">
                           </form>
                         </li>
		                </ul>
						<div class='bor_edit'>
